...
;; Give --depth=1 for git clone, make cloning faster. 
...
#+name: magit
#+BEGIN_SRC emacs-lisp 
(rw-straight-use-package 'with-editor "magit" "lczch")
(rw-straight-use-package 'transient "magit" "lczch")
(rw-straight-use-package 'lv "llvilanova" "lczch")
;;(rw-straight-use-package 'magit "magit" "lczch")

(rw-add-to-load-path (expand-file-name "transient/lisp" rw-straight-repos-dir))
(rw-add-to-load-path (expand-file-name "magit/lisp" rw-straight-repos-dir))

;; (load (expand-file-name "magit/lisp/magit-autoloads" rw-straight-repos-dir))
